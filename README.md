...
Includes a minimal [Node Cluster](https://nodejs.org/docs/latest-v8.x/api/index.html) [implementation](server/index.js) to parallelize the single-threaded Node process across the available CPU cores.
